...
int counter = 0; //Interrupt handler counter, global to avoid changing a function that already came defined - void timer_int_handler()
...
int(timer_set_frequency)(uint8_t timer, uint32_t freq) {
  ...
  uint8_t control_word = TIMER_SEL(timer) | TIMER_LSB_MSB | last_bits; //building control word
